// src/lib.rs
/*
 * Core library for NodeConnector
 */
...
#[derive(Debug)]
pub struct NodeConnectorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeConnectorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeConnector processing");
    
    let mut processor = NodeConnectorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeConnectorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeConnectorProcessor::new(false);
